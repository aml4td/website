library(rpart)
library(partykit)
library(animation)  # patchwork doesn't work with gganimate
library(tidymodels)
library(patchwork)
...
saveGIF(
	...
	movie.name = "anime_tree_collapse_dark.gif",
	interval = 1,
	nmax = 50,
	ani.width = 600 * 2,
	ani.height = 600 * 2,
