...
A related class of models is for ordered outcome categories [@mccullagh1980regression;@williams2020ordinal]. These models are inherently multinomial; otherwise, basic logistic would be appropriate. 
...
for $j < C$ and $\boldsymbol{\beta}$ only contains slope parameters. The slopes are class independent, meaning all of the predictors share the same pattern across classes. This can be made class-specific, leading to a non-proportional model. 
