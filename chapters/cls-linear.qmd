...
where there are $p_l$ feature that enter the model linearly and $p_s$ that are nonlinear as defined by the function $f_{j'}(\cdot)$. This isn't very different from our previous logistic models with nonlinear terms. ADDITIVE ASSUMPTION
