...
Given the spatial structure of our data, mapping residuals geographically is also useful—it can reveal particular locations where predictions are consistently poor. We can identify those points with the largest absolute residuals and investigate what makes them different. 
