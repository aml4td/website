...
forest_int_rec <- 
  forest_rec %>% 
  step_interact(
    ~`dew temperature`:elevation + longitude:`minimum vapor` + 
      longitude:`maximum vapor` + `dew temperature`:`january minimum temperature` + 
      `dew temperature`:`maximum vapor` + latitude:longitude + 
      longitude:roughness + `annual maximum temperature`:`dew temperature` + 
      `annual minimum temperature`:`dew temperature` + 
      `annual maximum temperature`:`maximum vapor`
  )
