...
conversion to basic model parameters; VIP calculations; how do we get probability estimates from the model? Is PLSDA just PLS on an indicator outcome matrix? Do we want to save any of this for the regression section (without repeating it?)
