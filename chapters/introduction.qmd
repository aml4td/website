...
library(stringr)
library(tidymodels)
library(textrecipes) # requires pks textfeatures and stopwords
library(gt)
...
* Post-model adjustments to predictions, such as model calibration ([Section -@sec-calibration-whole-game] and TODO), are examples of postprocessing operations.
...
<p style="text-align: center;"><b>model pipeline = preprocessing + supervised model + postprocessing</b></p>
:::
