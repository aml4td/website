...
<tt>Code</tt>: `r r_comp("embeddings.html#sec-barley")`
...
<tt>Code</tt>: `r r_comp("embeddings.html#principal-component-analysis")`
...
<tt>Code</tt>: `r r_comp("embeddings.html#independent-component-analysis")`
...
<tt>Code</tt>: `r r_comp("embeddings.html#numeric-pls")`
...
<tt>Code</tt>: `r r_comp("embeddings.html#sec-isomap")`
...
<tt>Code</tt>: `r r_comp("embeddings.html#sec-umap")`
...
<tt>Code</tt>: `r r_comp("embeddings.html#sec-centroids")`
...
three_class_path <- 
  ...
  geom_point(data = cent_overall, col = "black", cex = 8, pch = 21, show.legend = FALSE)  +
  labs(x = expression(x[1]), y = expression(x[2])) +
  scale_color_brewer(palette = "Dark2") + 
