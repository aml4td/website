...
three_class_path <- 
  ...
  geom_path(data = cent_shrunk_path, aes(col = class), show.legend = FALSE, arrow=arrow(angle=30, length=unit(0.1, "inches"), ends="last", type="open")) +
  geom_point(data = cent_overall, col = "black", cex = 3, pch = 21, show.legend = FALSE)  +
  labs(x = expression(x[1]), y = expression(x[2])) +
  scale_color_brewer(palette = "Dark2") + 
