...
```{r}
#| label: pca-rotation-gif-light
#| echo: false
#| fig-align: center
#| out-width: 90%

knitr::include_graphics("../premade/anime-barley-pca-light.gif")
```
...
```{r}
#| label: pca-rotation-gif-dark
#| echo: false
#| fig-align: center
#| out-width: 90%

knitr::include_graphics("../premade/anime-barley-pca-dark.gif")
```
...
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-linear-scores.R")
...
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-setup.R")
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-linear-loadings.R")
...
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-setup.R")
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-umap.R")
...
three_class_path <- 
  ...
  geom_point(data = cent_overall, col = "black", cex = 8, pch = 21, 
             show.legend = FALSE)  +
  labs(x = expression(x[1]), y = expression(x[2])) +
  scale_color_brewer(palette = "Dark2") + 
