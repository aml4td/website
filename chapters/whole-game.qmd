...
#| fig-alt: "A series of confidence intervals for the increased delivery time when an item is ordered. Most items have confidence intervals that contain zero. One item (number 19), has an upper bound that is less than zero. Several others have lower bounds that are greater than zero. Two items, numbers one and ten, have very large percent increases whose confidence intervals do not cover zero."
