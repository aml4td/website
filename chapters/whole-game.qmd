...
We'll avoid many details in this chapter by copiously referencing upcoming chapters. Also, in this an upcoming chapters, there are icons (e.g., {{< fa brands r-project >}}) that link to seperate pages that illustrate how to perforrm the calculations. 
