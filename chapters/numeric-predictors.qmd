...
lot_area_raw <- 
  ames_train %>% 
  ggplot(aes(Lot_Area)) + 
  geom_histogram(bins = 30, col = "#00000000", fill = "#8E195C", alpha = 1 / 2) +
...
lot_area_yj <- 
  ...
  ggplot(aes(Lot_Area)) +
  geom_rug(alpha = 1 / 2, length = unit(0.04, "npc"), linewidth = 1.2) + 
  geom_histogram(bins = 20, col = "#00000000", fill = "#8E195C", alpha = 1 / 2) +
...
lot_area_pctl <- 
  ...
  ggplot(aes(Lot_Area)) +
  geom_rug(alpha = 1 / 2, length = unit(0.04, "npc"), linewidth = 1.2) + 
  geom_histogram(binwidth = 0.05, col = "#00000000", fill = "#8E195C", alpha = 1 / 2) +
...
data_cols <- c(rgb(0.27, 0.59, 0.15), "darkblue")
