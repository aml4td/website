...
#| cache: true
set.seed(905)
nlin_compare <- compare_models(all_sets, chains = 10, cores = 10, iter = 5000)
nlin_compare
...
At this point, the `r nlin_best` model has the smallest Brier score. 
