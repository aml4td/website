...
#| fig-height: 2.8
#| warning: false
#| fig-cap: "The validation loss function for the same MLP model for four optimzation strategies. The lines on each panel represents runs initialized with different random numbers."
