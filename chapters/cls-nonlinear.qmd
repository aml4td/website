...
## Nonlinear Support Vector Machines {#sec-cls-svm-nlin}

`r r_comp("cls-nonlinear.html#sec-cls-svm-nlin")`
...
load("../RData/forest_svm_linear_set_res.Rdata")
...
nlin_subset <-
  ...
  mutate(
    ...
    model = ifelse(
      grepl("_SVM (linear)", model, fixed = TRUE),
      "SVM (linear)",
      model
    ),
