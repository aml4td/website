...
#| fig-alt: "Two-panel figure comparing forestation models. The left panel is a dot-and-whisker plot of Brier scores with 90% credible intervals for each model, ordered from best to worst. A cluster of models including logistic regression have similar low Brier scores, while naive Bayes performs notably worse. The right panel shows horizontal bars for the probability of practical equivalence to the best model."
p_brier <-
  nlin_subset |>
