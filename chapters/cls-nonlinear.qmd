...
#| label: fda-details
#| include: false
forest_fda_best <- tibble(num_terms = 40, prune_method = "forward", prod_degree = 2)
...
excluded <- fda_imp$text[is.na(fda_imp$used)]
...
forest_fda_res |> 
  ...
  mutate(
    ...
    prune_method = paste("Pruning via", prune_method)
  ) |> 
...
The underlying MARS model did not use these predictors: `r exluded_text`. 
