...
For a node with $n$ training samples and $n_e$ misclassifications, the apparent error rate is $E/n$. The pessimistic error rate is calculated using the upper bound of a confidence interval for this proportion:

$$
\text{pessimistic error rate} = \frac{n_e + z_{\alpha/2} \sqrt{\frac{n_e(n-n_e)}{n}}}{n}
$$
