...
forest_obl_res <- obl_set_res |> extract_workflow_set_result("basic_Ridge")
...
#| fig-width: 6
#| fig-height: 3.75
#| fig-cap: "Tuning results for the oblqiue tree models showing how $n_{min}$ relates to the Brier score and the number of terminal nodes for each method of estimating the logistic regression model."
