...
```{r}
#| label: fig-ames-selection-light
#| echo: false
#| fig-align: center
#| out-width: 70%

knitr::include_graphics("../premade/anime-ames-selection-light.gif")
```
...
```{r}
#| label: fig-ames-selection-dark
#| echo: false
#| fig-align: center
#| out-width: 70%

knitr::include_graphics("../premade/anime-ames-selection-dark.gif")
```

:::

Maximum dissimilarity sampling of 25 points in the Ames data. The small black circles are individual properties. Larger, lighter colors indidicate earlier selection.
