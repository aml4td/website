...
We'll use these data in various ways in @sec-reg-linear to @sec-reg-summary; these data are used as a case study and are explored more. Our goal is to predict the average daily rate (ADR, i.e., the average cost in euros) from one of the two hotels in the original data. 
...
```{r}
#| label: fig-agents
#| fig-cap: "The frequency distirbution of agents in the training set. "
#| fig-width: 7
#| fig-height: 3
#| out-width: 70%
hotel_rate_train %>% 
