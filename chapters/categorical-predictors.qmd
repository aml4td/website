...
$$
y_{ij} = { \underbrace{\color{black} (\beta_0 + \beta_{0j})}_{\text{intercept(s)}} }  + \epsilon_{ij} = \mu_j + \epsilon_{ij}
...
agent_dark <- 
  ...
  geom_point(aes(size = n), alpha = 1/5, col = "#CCDEEC") +
  dk_thm
...
blup_dark <- 
  blup_plot  +
  geom_histogram(col = dark_bg, bins = 20) +
