...
Nested resampling reports that the optimal Brier score for the tuning process is `r knn_sfd_nest_brier` with a standard error of `r knn_sfd_nest_brier_se`. 
