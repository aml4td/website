...
bst_grids_p +
  geom_point(cex = 2, alpha = 2 / 3, col = "#CCDEEC") +
  dk_thm
```
...
race_p + 
  geom_point(aes(x = estimate), cex = 1 / 2, col = "#CCDEEC") +
  geom_vline(xintercept = 0, lty = 2) +
  geom_errorbar(aes(xmin = conf.low, xmax = estimate, col = Decision), 
                alpha = 1 / 3, col = "#CCDEEC") +
  dk_thm
```
:::
...
p_diff_dk <- 
  p_diff + 
  geom_boxplot(col = "#CCDEEC", fill = dark_bg) +
