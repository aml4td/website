...
The figure's bottom panels illustrate the effect of the ReLU function, where values less than zero are set to zero. At this point, $H_{i2}$ and $H_{i3}$ have the most substantial effect on the model, but in opposite directions.
