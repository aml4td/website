...
where $\boldsymbol{W}_1^{(2)}$ is a ($10\times 10$) parameter matrix that enables more effective linear combinations of the activated inputs. It adds predictive capacity. 
