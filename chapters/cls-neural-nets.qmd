...
align_equations(cbind(coefs$model.0.bias, coefs$model.0.weight), c("", "A", "B"), paste0("H_{", 1:4, "}"))
```
...
top_weights <- sort(seq_along(weight_sum)[order(weight_sum, decreasing = TRUE)][1:2])
...
align_equations(cbind(coefs$model.2.bias, coefs$model.2.weight), c("", paste0("H_{", 1:4, "}")), paste0("Y_{", 1:2, "}"))
```
