...
In total, there are 53,023,736 learned parameters that have already been estimated. This count is the same regardless of the number of predictors, the number of categorical levels, or the number of classes (as long as $C \le C_{max}$). The vast majority of the parameters come from the 24 iterations of in-context learning. 

The next set of sebsections go into more detail for each phase of the model. 
