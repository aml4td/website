...
- The third location has two patterns. $A_1$ and $A_3$ are mostly equal blends of $H_1$ and $H_3$. Also, $A_2$ and $A_4$ are equal blends across their four antecedents. 
