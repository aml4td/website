...
#| fig-width: 4
#| fig-height: 5
#| fig-alt: "Diagram showing the input-to-hidden-layer portion of a neural network. Predictor nodes on the left connect to a single hidden unit on the right via weighted lines. The linear combination of inputs is passed through an activation function to produce the hidden unit's output."
...
#| echo: false
#| results: "asis"
align_equations <- function(coefs, symbols, outputs, digits = 2) {
  n_eq <- nrow(coefs)
  n_terms <- ncol(coefs)
  n_align <- 1 + n_terms
