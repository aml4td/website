...
* Initial embedding dimension from `r autoint_rngs$num_embedding[1]` to  `r autoint_rngs$num_embedding[2]`.
* Dropout rate for intial embedding from `r autoint_rngs$dropout_embedding[1]` to  `r autoint_rngs$dropout_embedding[2]`.
* Attention embedding size from `r autoint_rngs$num_attn_feat[1]` to  `r autoint_rngs$num_attn_feat[2]`.
* Number of attention heads from `r autoint_rngs$num_attn_heads[1]` to  `r autoint_rngs$num_attn_heads[2]`.
* Number of attention blocks from `r autoint_rngs$num_attn_blocks[1]` to  `r autoint_rngs$num_attn_blocks[2]`.
* Dropout rate for attention parameters from `r autoint_rngs$dropout_attn[1]` to  `r autoint_rngs$dropout_attn[2]`.
* Learning rate from 10<sup>`r log10(autoint_rngs$learn_rate[1])`</sup> to 10<sup>`r log10(autoint_rngs$learn_rate[2])`</sup>.
* Rate schedules of `r cli::format_inline("{scheds}")`.
* Momentum from `r autoint_rngs$momentum[1]` to  `r autoint_rngs$momentum[2]`.
* Batch size from `r autoint_rngs$batch_size[1]` to  `r autoint_rngs$batch_size[2]`.
