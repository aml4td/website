...
A flexible discriminant fit to the myopia training set. Using the default probability cutoff of 50%, `r fda_plain_capture` of the `r sum(myopia_smol_party$class == "yes")` events are correctly predicted as events. 
::::
...
TODO talk about how the trade-off occurs here
