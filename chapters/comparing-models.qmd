...
#| fig-alt: "Dot plot of accuracy for three models using the same cross-validation folds, with lines connecting points from the same fold. The fold-to-fold pattern is clearly visible as parallel lines. Annotations decompose the variation for the highest boosting accuracy point into three parts: the model effect, the fold effect explaining most of the deviation, and a much smaller residual compared to the figure without fold blocking."
Fold03 <-
  for_fig |>
