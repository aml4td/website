...
`r r_comp("cls-metrics.html#cls-metrics-wts")`
...
`r r_comp("cls-metrics.html#cls-metrics-soft")`
...
compute_brier_int <- function(split) {
  ...
  diffs <- tibble(
    estimate = c(brier_raw$estimate - brier_logistic$estimate, 
...
diff_tbl <- diff_cal_int |> 
  ...
  dplyr::select(.lower_diff = .lower, .diff = .estimate, .upper_diff = .upper, term)
