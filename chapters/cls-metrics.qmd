...
#| fig-alt: "Two-panel calibration plot using moving windows after isotonic regression recalibration. Panel (a) shows a single isotonic regression result with a curve that tracks the diagonal but has some wiggle due to the step-function nature of the method. Panel (b) shows the bootstrapped ensemble result, which is smoother and closer to the diagonal with reduced variability compared to the single model."
cal_plot_5 <-
  iso_cal_val |>
  cal_plot_windowed(
    class,
