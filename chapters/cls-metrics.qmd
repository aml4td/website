...
As previously mentioned, accuracy is misleading when there is a class imbalance. There are a few ways to correct for imbalances, most notably the measure of agreement called Kappa. This normalizes the accuracy by a measure of expected accuracy based on chance agreement ($E$): 
