...
For example, we mentioned that naive Bayes models estimate the distributions of individual predictors. If a distribution is affected by missingness, the probabilities computed during prediction will be biased, perhaps systematically, and may result in poor results in new samples. 
