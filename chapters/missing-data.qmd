...
dark_svg <- gsub("rgb(100%, 100%, 100%)", h2rgb("#222"), dark_svg, fixed = TRUE)
# convert black to "#adb5bd"
dark_svg <- gsub("rgb(0%, 0%, 0%)", h2rgb("#adb5bd"), dark_svg, fixed = TRUE)
# convert red to "#CCDEEC"
dark_svg <- gsub("rgb(100%, 0%, 0%)", h2rgb("#CCDEEC"), dark_svg, fixed = TRUE)
# Convert some boxes to dark box color
dark_svg <- gsub("rgb(20%, 20%, 20%)", h2rgb("#adb5bd"), dark_svg, fixed = TRUE)
...
ggplot(imputation_distance_comparison, aes(x = Method, y = Distance)) +
  geom_boxplot(outlier.size = 0, col = "#adb5bd", fill = "#CCDEEC") +
