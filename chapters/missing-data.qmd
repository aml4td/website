...
Like nearest-neighbor imputation, the bagged tree places most of the imputed values close to the original data distribution, as seen in @fig-imputation-comparison. The distribution of distances (@fig-imputation-distance-comparison) for bagged imputation is similar to that of nearest neighbors.
...
[TODO:  ADD SHINY LIVE APP TO COMPARE IMPUTATION TECHNIQUES]
