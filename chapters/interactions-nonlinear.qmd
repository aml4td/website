...
lin_reg_cal_dk <- 
  lin_reg_cal +
  geom_point(alpha = 0.4, cex = 1, col = "#CCDEEC") +
  geom_smooth(se = FALSE, col = "red") +
  dk_thm
...
p_hour_ind_dk <-
  p_hour_ind + 
  geom_line(alpha = 1 / 50, col = "#CCDEEC") +
  dk_thm
...
p_hour_dk <-
  p_hour_p +
  geom_line(linewidth = 1, col = "#CCDEEC") +
  dk_thm
...
orf_two_way_int_p +
  geom_bar(stat = "identity", fill = "#CCDEEC") +
  dk_thm
```
...
sim_p + 
  geom_line(data = sim_grid, lty = 3, col = "#CCDEEC") +
  dk_thm
```
...
pie_p + 
  theme(
    ...
    axis.title.x = ggplot2::element_text(colour = "#adb5bd"),
    axis.title.y = ggplot2::element_text(colour = "#adb5bd"),
...
bin_p + 
  geom_point(aes(age, ratio), alpha = 3 / 4, pch = 1, cex = 3, col = "#CCDEEC") +
  dk_thm
```
