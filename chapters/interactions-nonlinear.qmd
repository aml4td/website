...
TODO correlated predictors, use logit for classification models. @inglis2022visualizing have a good summary of the potential issues with using $H^2$. Alternatives can be found in @hooker2004discovering, @greenwell2018simple, @herbinger2022repid, and @oh2022predictive
...
There are many types of splines but one, the "natural cubic spline," is shown in Panel (c) of @fig-basis-expansions. 
