...
day_cols <-  c("#808080", "#24FF24FF", "#009292FF",  "#B66DFFFF", 
...
day_cols <- c(
  "#808080", "#24FF24FF", "#009292FF", "#B66DFFFF",
  "#6DB6FFFF", "#920000FF", "#FFB6DBFF"
)
...
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-setup.R")
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-polynomial.R")
...
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-setup.R")
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-piecewise.R")
...
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-setup.R")
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-simple-spline.R")
...
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-setup.R")
source("https://raw.githubusercontent.com/aml4td/website/dark-mode/R/shiny-natural-spline.R")
...
if (file.exists("../RData/sim_res.RData")) {
  load("../RData/sim_res.RData")
} else {
  set.seed(614)
  sim_res <- 
  ...
  save(sim_res, file = "../RData/sim_res.RData")
}
```
...
fossil_df %>% 
  ggplot() + 
  geom_point(aes(age, ratio), pch = 1, cex = 3, col = "grey") +
