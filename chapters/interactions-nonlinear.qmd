...
Several approaches to modeling data from @bralower1997mid. The black dashed line is the true function and the shaded regions are 95% confidence intervals around the mean. 
...
::: {#fig-piecewise-polynimials}

::: {.figure-content}

```{shinylive-r}
#| label: fig-piecewise-polynimials
#| viewerHeight: 600
#| viewerWidth: "100%"
#| standalone: true
