...
two_cand_p +
  annotate("text", x = 6.5, y = 1.25, label = "Current\nbest", col = "#CCDEEC") + 
  geom_vline(mapping = aes(xintercept = 6), lty = 2, col = "#CCDEEC") +
  dk_thm
...
smoothed_p_dk <-
  smoothed_p +
  geom_point(data = raw_plot_data, cex = 1/2, col = "#CCDEEC") +
  dk_thm
...
diff_p_dk <- 
  diff_p +
  geom_hline(yintercept = 0, lty = 2, alpha = 1 / 2) +
  geom_point(data = raw_diff_plot_data, cex = 1/2, col = "#CCDEEC") +
  dk_thm
...
mlp_sfd_p+
  scale_color_manual(values = c("#CCDEEC", "#FF7F00")) +
