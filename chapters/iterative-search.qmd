...
### What Makes a Model Bayesian? {#sec-bayesian-intro}
...
We’ll encounter even more Bayesian methods as we proceed. Now, let’s get back to how priors can be used for optimizing tuning parameters. 
