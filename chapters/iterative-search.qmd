...
load("../RData/bayesian_opt_1d.RData")
# source("https://raw.githubusercontent.com/aml4td/website/main/R/shiny-setup.R")
light_bg <- "#fcfefe" # from aml4td.scss
grid_theme <- bs_theme(
  bg = light_bg, fg = "#595959"
...
An example of Bayesian optimization for the function $f(\theta) = \theta\: cos(\theta/2)$.
