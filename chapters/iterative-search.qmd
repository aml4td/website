...
where $\rho < 1$ [@joseph2007functionally]. More extensive discussions can be found in @qian2008bayesian, @zhou2011simple, and @saves2023mixed.
...
@genton2001classes, [@cristianini2004, Part II], and [@garnett2023, chapt 4]  contain overviews of kernel functions, their different classes, and how they can be used and combined for data analysis.
