...
Several approaches to modeling the nonlinear relationship $y = x^3 +2exp[-6(x - 0.3)^2] $. The black dashed line is the true function and the shaded regions are 95% confidence intervals around the mean. 
