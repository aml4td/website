...
spline_3 <-
  ...
  ggplot(aes(x = x, y = y)) +
  geom_point(alpha = 1 / 4) + 
  geom_path(data = regional_1$grid, col = "#1B9E77", linewidth = 2.8, alpha = alphas) + 
  geom_path(data = regional_2$grid, col = "#D95F02", linewidth = 2.8, alpha = alphas) + 
  geom_path(data = regional_3$grid, col = "#7570B3", linewidth = 2.8, alpha = alphas) +
  labs(x = "predictor", y = "response") +
