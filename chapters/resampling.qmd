...
We specified 10 resamples from the grid. To accomplish this, we sequentially assigns each hexagon in the 2D grid to integers 1 through 10. For the first resample, we pool the hexagonal regions labeled with a 1 to define the overall assessment set. All other data, excluding any within the buffer (if any), are reserved for the analysis set. @fig-forested-blockcv shows the  end product for the first of our 10 folds. 
