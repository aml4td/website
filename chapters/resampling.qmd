...
(mc_bias + theme_transparent()) +
    (mc_prec + theme_transparent()) +
...
( vfold_bias + theme_transparent()) +
  ( vfold_prec  + theme_transparent()) +
  plot_layout(guides = 'collect') &
  theme(legend.position = "top")
...
(boot_bias + theme_transparent()) +
  (boot_prec + theme_transparent()) +
  plot_layout(guides = 'collect') &
  theme(legend.position = "top")
