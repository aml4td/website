...
#### What happens to the $B$ models? Which one should I keep? {#sec-resampling-Q03 .unnumbered}

The $B$ models fit within resampling are _only used_ to estimate how well the model fits the data. You don’t need them after that. You can retain them for diagnostic purposes though. As mentioned above, using the replicate models to look into how parts of the model change can be helpful. 
