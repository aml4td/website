...
For professors looking to use these materials, the rendered images are in the [gh-pages GitHub branch](https://github.com/aml4td/website/tree/gh-pages/) in the `figures` and `premade` directories. As we write, we will also populate [`exercises.aml4td.org`](https://exercises.aml4td.org/). 

## Is there code?  {.unnumbered}

We definitely want to decouple the content from specific software. [One of our other books](http://appliedpredictivemodeling.com/) on modeling had computing sections. They are nice to peruse, and people enjoyed having them there. However, they can quickly become outdated and take up a lot of space. The sources for the material use R, and early adopters can find them in the [GitHub repository](https://github.com/aml4td/website). 

There are plans to make subdomains for different computing platforms, starting with [tidymodels](https://www.tidymodels.org):

- [`tidymodels.aml4td.org`](http://tidymodels.aml4td.org)
